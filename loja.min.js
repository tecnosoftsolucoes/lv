$(function() {
    ...
    function montaItem(cfg, item) {
        html = "";
        if (cfg.GUEST == 1) {
            html += '<a class="float-right text-danger btn btn-lg btn-link mdi mdi-heart" href="/login"></a>';
        } else {
            if (item.DESEJO == 0) {
            ...
            if (item.KIT > 0) {
                ...
                if (cfg.PROD_SEM_ESTOQUE == 1 && item.DISPONIVEL == 2 && cfg.EST_FAB_HABILITAR == 0 ||
                    ...
                    if (cfg.PESQ_EXIB_BOT_ENV_CESTA >= 1) {
                        html += '<div class="mt-1 divbtComprar mx-md-3 mx-1 ' + (cfg.OCULTAR_BT_COMPRAR == 1 ? 'invisible' : '') + '">';
                        if (cfg.EXIB_COMBO_QTDE == 1) {
                            ...
                            html += '<div class="row mx-1 mx-md-3 mb-1 btComprarHabilitado">'+
                            '   <button id="ec' + item.ID_PROD + '" class="col-xs-12 btn btn-block btn' + cfg.BUTTON_CLASS + cfg.PESQ_BUTTON_COMPRAR + ' enviarcesta" value="' + item.UNID_VENDA + '">Adicionar'+
                            '       <span id="icone' + item.ID_PROD + '" class="mdi mdi-' + cfg.CHECKOUT_ICON_CLASS_ADD + '"></span>'+
                            '   </Button>'+
                            '</div>';
                        }
                    ...
                    if (cfg.PESQ_EXIB_BOT_COMPRAR == 1) {
                        html += '<div class="divbtComprar mx-md-3 mx-1 ' + (cfg.OCULTAR_BT_COMPRAR == 1 ? 'invisible' : '') + '">';
                        if (cfg.PESQ_EXIB_BOT_ENV_CESTA == 0 && cfg.EXIB_COMBO_QTDE == 1) {
                            ...
                            html += '<div class="row mx-1 mx-md-3 mb-1 btComprarHabilitado">';
                            html += '<button id="' + item.ID_PROD + '" class="col-xs-12 btn btn-block btn' + cfg.BUTTON_CLASS + cfg.PESQ_BUTTON_COMPRAR + ' comprar" value="' + item.UNID_VENDA + '">Comprar <span id="icone' + item.ID_PROD + '" class="mdi mdi-' + cfg.CHECKOUT_ICON_CLASS_ADD + '"></span></Button>';
                            html += '</div>';
                        }
                        html += '</div>';
                    }
